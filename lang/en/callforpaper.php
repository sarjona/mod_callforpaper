...
/**
 * Strings for component 'mod_callforpaper', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['availablefromdate'] = 'Opening date';
...
$string['availabletodate'] = 'Closing date';
...
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all callforpapers. You will still need to turn feeds on manually in the settings for each callforpaper.';
...
$string['callforpaper:addinstance'] = 'Add a new callforpaper';
$string['callforpaper:approve'] = 'Approve and undo approved entries';
$string['callforpaper:exportallentries'] = 'Export all callforpaper entries';
$string['callforpaper:exportentry'] = 'Export a callforpaper entry';
$string['callforpaper:exportownentry'] = 'Export own callforpaper entry';
$string['callforpaper:exportuserinfo'] = 'Export user information';
$string['callforpaper:manageentries'] = 'Manage entries';
$string['callforpaper:managetemplates'] = 'Manage templates';
$string['callforpaper:manageuserpresets'] = 'Manage presets';
$string['callforpaper:rate'] = 'Rate entries';
$string['callforpaper:readentry'] = 'Read entries';
$string['callforpaper:viewalluserpresets'] = 'View presets from all users';
$string['callforpaper:viewallratings'] = 'View all raw ratings given by individuals';
$string['callforpaper:viewanyrating'] = 'View total ratings that anyone received';
...
$string['errorcallforpaperfilenotfound'] = 'The file could not be imported. Accepted file types are CSV or a ZIP containing a CSV file in the format used for exporting entries.';
...
$string['fieldnotmatched'] = 'The following fields in your file are not known in this callforpaper: {$a}';
$string['fieldoptions'] = 'Options (one per line)';
$string['fields'] = 'Fields';
$string['fieldshelp'] = 'Create fields to collect different types of data. Fields define the structure of the entries in your callforpaper.';
...
$string['invalidid'] = 'Incorrect callforpaper ID';
...
$string['manageapproved_help'] = 'Allow speakers to edit or delete their entries after they\'ve been approved.';
...
$string['maxentries'] = 'Maximum number of submissions per speaker';
$string['maxentries_help'] = 'Enter a number or leave blank for unlimited submissions.';
...
$string['modulename_link'] = 'mod/callforpaper/view';
$string['modulenameplural'] = 'Call for papers';
$string['more'] = 'More';
...
$string['newfield_help'] = 'A field allows the input of data. Each entry in a callforpaper activity can have multiple fields of multiple types such as a date field, which allows participants to select a day, month and year from a drop-down menu, a picture field, which allows participants to upload an image file, or a checkbox field, which allows participants to select one or more options.
...
$string['nofieldincallforpaper'] = 'There are no fields defined for this callforpaper.';
...
$string['page-mod-callforpaper-x'] = 'Any callforpaper activity module page';
...
$string['privacy:metacallforpaper:commentpurpose'] = 'Comments on callforpaper records';
$string['privacy:metacallforpaper:callforpaper_content'] = 'The content of a field';
$string['privacy:metacallforpaper:callforpaper_content:fieldid'] = 'Field definition ID';
$string['privacy:metacallforpaper:callforpaper_content:content'] = 'Content';
$string['privacy:metacallforpaper:callforpaper_content:content1'] = 'Additional content 1';
$string['privacy:metacallforpaper:callforpaper_content:content2'] = 'Additional content 2';
$string['privacy:metacallforpaper:callforpaper_content:content3'] = 'Additional content 3';
$string['privacy:metacallforpaper:callforpaper_content:content4'] = 'Additional content 4';
$string['privacy:metacallforpaper:callforpaper_records'] = 'Records in the callforpaper activity';
$string['privacy:metacallforpaper:callforpaper_records:userid'] = 'User who created the record';
$string['privacy:metacallforpaper:callforpaper_records:groupid'] = 'Group';
$string['privacy:metacallforpaper:callforpaper_records:timecreated'] = 'Time when record was created';
$string['privacy:metacallforpaper:callforpaper_records:timemodified'] = 'Time when record was last modified';
$string['privacy:metacallforpaper:callforpaper_records:approved'] = 'Approval status';
$string['privacy:metacallforpaper:callforpaperfieldnpluginsummary'] = 'Fields for callforpaper activity module';
...
$string['removeallcallforpapertags'] = 'All callforpaper tags';
...
This is not compatible with the callforpaper auto-linking filter.';
...
$string['savecallforpaperaspreset'] = 'Save all fields and templates and publish as preset on this site';
$string['saveaspresetmissingcapability'] = 'The user does not have permission to save the callforpaper as a preset.';
...
$string['undefinedprocessactionmethod'] = 'No action method defined in callforpaper_Preset to handle action "{$a}".';
...
$string['uploadrecords_help'] = 'Import entries that you have exported from another callforpaper, either via CSV or a ZIP containing a CSV file (if files are included in the export).

Alternatively, to create a CSV file for importing, add one entry to the callforpaper and then export it. Edit the CSV file and add more entries.';
$string['uploadrecords_link'] = 'mod/callforpaper/import';
$string['url'] = 'URL';
...
$string['maxreviewers'] = 'Number of reviewers per submission';
$string['maxreviewers_help'] = 'Enter a number, for example 3';
...
$string['reviewsdate'] = 'Release date';
$string['reviewsdate_help'] = 'On this date, all completed reviews will become visible to reviewers.';
